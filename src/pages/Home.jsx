...
export default function Home() {
  return (
    <BodySheets >
      <Typography>Experienced software engineer with expertise in GitOps and cloud native software development. Passionate about understand developer friction to make room for communication and collaboration.  </Typography>
      ...
      <Typography>In my spare time, I enjoy painting, gardening, and taking pictures of toast.  </Typography>
    </BodySheets>
  );
}